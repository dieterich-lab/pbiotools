...
header_re = r"{}\s*{}\s*{}\s*{}\s*{}\s*{}".format(
    transcript_id_re, gene_re, cds_re, loc_re, exons_re, segs_re
)
...
def get_all_headers(transcripts_fasta_file):
    ...
    Imports:
        ...
        misc.parallel
    """
    import pbiotools.misc.bio as bio
...
def get_all_utrs(transcripts_fasta_file, progress_bar=False):
    ...
    all_utr_info = parallel.apply_iter_simple(
        transcripts, get_utr_info, progress_bar=progress_bar, total=read_count
    )
